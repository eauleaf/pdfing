...
#'
#' @examples
#' list.files(pattern = '(?i)pdf$', full.names = T, recursive = T) |>
#' map(~pdf_embed_ocr(., '--deskew', '--rotate-pages', '--threshold', '--skip-text', '--redo-ocr', '--clean','-remove-background'))
#' pdf_embed_ocr('/home/tristan/Desktop/Cathy Idaho Tax Payment/gutke/recent_gutke_chk_pmts.pdf','--deskew', '--clean')
#' pdf_embed_ocr('/home/tristan/Desktop/Cathy Idaho Tax Payment/gutke/recent_gutke_chk_pmts.pdf', '--deskew', path_save = '/home/tristan/Desktop/Cathy Idaho Tax Payment/gutke/out.pdf')
#' pdf_embed_ocr('/home/tristan/Desktop/Cathy Idaho Tax Payment/gutke/recent_gutke_chk_pmts.pdf', '--redo-ocr')
#' pdf_embed_ocr('/home/tristan/Desktop/Cathy Idaho Tax Payment/gutke/recent_gutke_chk_pmts.pdf')
#'
pdf_embed_ocr <- function(path_read, ..., path_save = NULL){

  if( Sys.info()[1] != 'Linux'){ stop('Embedded OCR is only implemented on Linux. Try pdf_ocr_text() instead.')}
...
#' R implementation of OCRmyPDF for linux
#' To install on Linux https://ocrmypdf.readthedocs.io/en/latest/installation.html
#' R implementation of OCRmyPDF for windows
...
#' @export
#'
#' @examples   list.files(pattern = '(?i)pdf$', full.names = T, recursive = T) %>%
# map(~pdf_embed_ocr(., '--deskew', '--rotate-pages', '--threshold', '--skip-text', '--redo-ocr', '--clean','-remove-background'))
# pdf_embed_ocr('/home/tristan/Desktop/Cathy Idaho Tax Payment/gutke/recent_gutke_chk_pmts.pdf','--deskew', '--clean')
# pdf_embed_ocr('/home/tristan/Desktop/Cathy Idaho Tax Payment/gutke/recent_gutke_chk_pmts.pdf', '--deskew', path_save = '/home/tristan/Desktop/Cathy Idaho Tax Payment/gutke/out.pdf')
# pdf_embed_ocr('/home/tristan/Desktop/Cathy Idaho Tax Payment/gutke/recent_gutke_chk_pmts.pdf', '--redo-ocr')
